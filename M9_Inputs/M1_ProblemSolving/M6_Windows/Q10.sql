...
Write a query to rank cities by their population density, with the city with the highest population density being ranked 1. 
...
SELECT city_name, ROW_NUMBER() OVER(ORDER BY population/area_sq_mi DESC) AS density_rank 
FROM cities; 
